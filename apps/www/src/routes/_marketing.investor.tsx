...
export const Route = createFileRoute("/_marketing/investor")({
  component: InvestorPage,
  head: () => ({
    meta: [
      { title: "Investor Pitch – Genia" },
      {
        name: "description",
        content:
          "Explore the Genia investor narrative, metrics, and roadmap in an interactive deck designed for partners and advisors.",
      },
    ],
  }),
})
